...
function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        E.innerHTML=" Good morning, I am Jasmine Shi";
    } else if (h>=12 && h<18) {
        E.innerHTML+=" Good afternoon, I am Jasmine Shi";
    } else if (h>=18 && h<20) {
        E.innerHTML=" Good evening, I am Jasmine Shi";
    } else  {
        E.innerHTML="Good night, I am Jasmine Shi";
    } }
/* greetingFunc(); */
